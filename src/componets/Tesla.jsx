...
function Tesla() {
  return (
    <section > 
         <div className='sm:px-28 sm:py-12  sm:flex-row flex flex-col text-[10px] px-5 py-3 bg-background ' >

        <img src={tesla} className= "sm:w-[208px] sm:h-[208px] w-[108px] h-[108px] rounded-[15px] sm:mr-16"  alt="" />
